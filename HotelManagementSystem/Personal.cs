...
namespace HotelManagementSystem
{
    public partial class Personal : Form
    {
        ...
        {
            con.Open();
            string query = "select id,username,email from personal order by id";
        ...
        {
            con.Open();
            string delQuery = "delete from personal where id = " + tb_id.Text + "";
        ...
        {
            con.Open();
            string editQuery = "update personal set username = '" + tb_username.Text + "',email = '" + tb_email.Text + "'," +
        ...
        {
            con.Open();
            string searchQuery = "select id,username,email from personal where username like '%" + tb_search.Text + "%'";
